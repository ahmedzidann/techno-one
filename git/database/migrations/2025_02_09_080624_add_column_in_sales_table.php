...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('sales', function (Blueprint $table) {
            ...
            // Add foreign key
            $table->foreign('tele_sales_am', 'sales_tele_sales_am_id_foreign')
                ->references('id')
                ->on('employees')
                ->cascadeOnUpdate()
                ->nullOnDelete();
            ...
            $table->foreign('tele_sales_pm', 'sales_tele_sales_pm_id_foreign')
                ->references('id')
                ->on('employees')
                ->cascadeOnUpdate()
                ->nullOnDelete();
    ...
    public function down()
    {
        Schema::table('sales', function (Blueprint $table) {
            ...
            $table->dropForeign('sales_tele_sales_am_id_foreign');
            $table->dropForeign('sales_tele_sales_pm_id_foreign');
