...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">الانتاج</h5>

            <div>
                <a href="{{route('productions.create')}}" class="btn btn-primary">اضافة  انتاج</a>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> الانتاج </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'productions'])

    <script>
        $(document).on('click','.showDetails',function (){
            var id=$(this).attr('data-id');
            var route="{{route('admin.getProductionDetails',':id')}}";
    ...
    <script>
        $(document).on('click','.editBtn-p',function (){
            ...
            var url = "{{route("productions.edit",':id')}}";
