    ...
    <div class="d-flex flex-column mb-7 fv-row col-sm-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
         ...
         <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            <!--begin::Label-->
            <label for="phone" class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                <span class="required mr-1">الرقم القومي</span>
            </label>
            <!--end::Label-->
            <input id="national_num"  type="text" class="form-control form-control-solid" name="national_num"
                value="{{ @$row->national_num }}" />
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="commercial_register"  type="text" class="form-control form-control-solid"
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="tax_card"  type="text" class="form-control form-control-solid" name="tax_card"
                value="{{ @$row->tax_card }}" />
        </div>
