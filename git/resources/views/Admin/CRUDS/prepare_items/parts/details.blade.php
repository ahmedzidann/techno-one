<tr id="tr-{{$id}}"  >
    ...
    <th >
        <div class="d-flex flex-column mb-7 fv-row col-sm-2 " style="width: 100%;">
            ...
            <select class="changeKhamId" data-id="{{$id}}" name="productive_id[]" id='productive_id-{{$id}}' style="width: 100%;">
    ...
    <th>
        <input data-id="{{$id}}" onchange="callTotal()" type="number" value="1" min="1"  name="amount[]" id="amount-{{$id}}" style="width: 100%;">

    </th>
    <th>
        <input step=".1" data-id="{{$id}}" onchange="callTotal()" type="number" value="1" min="1"  name="productive_sale_price[]" id="productive_sale_price-{{$id}}" style="width: 100%;">

    </th>
        <th>
        <input type="number" value="0" min="0" name="bouns[]" id="bouns-{{ $id }}" style="width: 100%;">
    </th>
    <th>
    ...
    <th>
        <input type="number" value="0" min="0" name="batch_number[]"
            id="batch_number-{{ $id }}" style="width: 100%;">
