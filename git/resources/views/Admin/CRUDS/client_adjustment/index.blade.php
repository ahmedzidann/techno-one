...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">تسويات العملاء</h5>

            <div>
                <button id="addBtn" class="btn btn-primary">اضافة تسوية عميل</button>
            </div>
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax', ['url' => 'client-adjustments'])
@endsection
