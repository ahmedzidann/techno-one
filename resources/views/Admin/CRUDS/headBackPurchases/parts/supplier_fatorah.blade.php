            ...
            <table id="table-details" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                ...
                <tbody id="details-container">
                    @foreach ($details as $key => $pivot)
                        <tr id="tr-{{ $key }}">
                            <th>
                                <input type="checkbox" class="check_data"  name="check_data[{{ $key }}]" value="{{ $pivot->productive_id }}" onchange="callTotal()">
                            </th>
                            <th style="padding: 8px;">
                                <div class="d-flex flex-column mb-7 fv-row col-sm-2">
                                    <select class="form-control changeKhamId" data-id="{{ $key }}" name="productive_id[]"
                            ...
                            <th style="padding: 8px;">
                                <input type="number" value="{{ $pivot->total }}" name="total[]"
