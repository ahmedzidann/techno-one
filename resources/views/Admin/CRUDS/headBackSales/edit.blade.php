...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @include('Admin.CRUDS.headBackSales.parts.editForm')
    ...
    @section('js')
        ...
        <script>
            ...
            $(document).on('change', '#client_id', function() {
                ...
                if (client) {
                    let url = '{{ route('admin.getSalesForClient', ['client_id' => ':id']) }}'.replace(':id',
                        client);
            ...
            $(document).on('change', '#sale_number_id', function(e) {
                ...
                if (sale) {
                    let url =
                        '{{ route('admin.head-back-sales.invoice-details', ['sale_number_id' => ':id']) }}'
                        .replace(':id', sale);
                    $.ajax({
                        type: 'GET',
                        url: url,
            ...
            (function() {
                ...
                if (sale) {
                    let url =
                        '{{ route('admin.head-back-sales.invoice-details-edit', ['sale_number_id' => ':id']) }}'
                        .replace(':id', sale);
                    $.ajax({
                        type: 'GET',
                        url: url,
        ...
        <script>
            @foreach (\App\Models\HeadBackSalesDetails::where('head_back_sales_id', $row->id)->get() as $key => $pivot)
