...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchases', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('storage_id')->nullable()->index('purchases_storage_id_foreign');
            ...
            $table->unsignedBigInteger('publisher')->nullable()->index('purchases_publisher_foreign');
